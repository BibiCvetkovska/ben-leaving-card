...
class TerminalSoundSystem {
	...
	playSuccessBeep() {
		...
		oscillator2.frequency.setValueAtTime(750, ctx.currentTime + 0.1);
	...
	playGlitchSound() {
		...
		const freqs = [200, 400, 600, 300, 500];
...
export const terminalSounds = new TerminalSoundSystem();
