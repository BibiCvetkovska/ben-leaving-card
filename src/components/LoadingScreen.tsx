      ...
      <div className="relative flex flex-col items-center gap-8 px-4">
        ...
        <div className="text-center space-y-4">
          <p className="text-terminal text-2xl font-bold glow">
            <span className="text-code-blue">{">"}</span> Initializing farewell protocol{dots}
          </p>

          {/* Terminal-style loading messages */}
          <div className="text-terminal/80 text-sm font-mono space-y-1">
            <p className={progress > 20 ? "text-terminal" : "text-comment"}>
              [✓] Loading nostalgia.db
            </p>
            <p className={progress > 40 ? "text-terminal" : "text-comment"}>
              [✓] Parsing developer_memories.json
            </p>
            <p className={progress > 60 ? "text-terminal" : "text-comment"}>
              [✓] Compiling goodbye_message.tsx
            </p>
            <p className={progress > 80 ? "text-terminal" : "text-comment"}>
          ...
          <p className="text-warning text-xs">
            {progress}% // <span className="text-comment">Warning: Emotions may be deprecated</span>
          </p>
        </div>
      </div>
    </div>
